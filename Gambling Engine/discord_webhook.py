...
class DiscordWebhookAlert:
    ...
    def send_alert(self, system_name: str, game_id: int, bet_target: str, odds: int, stake_percentage: float):
        """
        Formats and sends a betting alert to the Discord webhook.
        """
        embed = {
